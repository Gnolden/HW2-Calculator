...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.sq1 = QtWidgets.QDoubleSpinBox(self.kvadrati_page)
        self.sq1.setGeometry(QtCore.QRect(380, 60, 151, 41))
        self.sq1.setObjectName("sq1")
        self.label_24 = QtWidgets.QLabel(self.kvadrati_page)
        self.label_24.setGeometry(QtCore.QRect(290, 290, 67, 17))
        self.label_24.setObjectName("label_24")
        self.label_25 = QtWidgets.QLabel(self.kvadrati_page)
        self.label_25.setGeometry(QtCore.QRect(286, 66, 71, 31))
        self.label_25.setObjectName("label_25")
        self.sqr_perimeter = QtWidgets.QLCDNumber(self.kvadrati_page)
        self.sqr_perimeter.setGeometry(QtCore.QRect(390, 290, 64, 23))
        self.sqr_perimeter.setObjectName("sqr_perimeter")
        self.label_26 = QtWidgets.QLabel(self.kvadrati_page)
        self.label_26.setGeometry(QtCore.QRect(290, 230, 121, 17))
        self.label_26.setObjectName("label_26")
        self.sqr_area = QtWidgets.QLCDNumber(self.kvadrati_page)
        self.sqr_area.setGeometry(QtCore.QRect(390, 230, 64, 23))
        self.sqr_area.setObjectName("sqr_area")
        ...
        self.label_17.setGeometry(QtCore.QRect(240, 100, 71, 31))
        self.label_17.setObjectName("label_17")
        self.label_18 = QtWidgets.QLabel(self.trapecia_page)
        self.label_18.setGeometry(QtCore.QRect(240, 150, 71, 31))
        self.label_18.setObjectName("label_18")
        self.label_19 = QtWidgets.QLabel(self.trapecia_page)
        self.label_19.setGeometry(QtCore.QRect(280, 430, 111, 17))
        self.label_19.setObjectName("label_19")
        self.trpz_perimeter = QtWidgets.QLCDNumber(self.trapecia_page)
        self.trpz_perimeter.setGeometry(QtCore.QRect(410, 430, 64, 23))
        self.trpz_perimeter.setObjectName("trpz_perimeter")
        self.trpz3 = QtWidgets.QDoubleSpinBox(self.trapecia_page)
        self.trpz3.setGeometry(QtCore.QRect(370, 140, 151, 41))
        self.trpz3.setObjectName("trpz3")
        self.trpz_area = QtWidgets.QLCDNumber(self.trapecia_page)
        self.trpz_area.setGeometry(QtCore.QRect(410, 380, 64, 23))
        self.trpz_area.setObjectName("trpz_area")
        self.trpz2 = QtWidgets.QDoubleSpinBox(self.trapecia_page)
        self.trpz2.setGeometry(QtCore.QRect(370, 90, 151, 41))
        self.trpz2.setObjectName("trpz2")
        self.label_20 = QtWidgets.QLabel(self.trapecia_page)
        self.label_20.setGeometry(QtCore.QRect(240, 46, 71, 31))
        self.label_20.setObjectName("label_20")
        self.label_21 = QtWidgets.QLabel(self.trapecia_page)
        self.label_21.setGeometry(QtCore.QRect(280, 380, 101, 17))
        self.label_21.setObjectName("label_21")
        self.trpz1 = QtWidgets.QDoubleSpinBox(self.trapecia_page)
        self.trpz1.setGeometry(QtCore.QRect(370, 40, 151, 41))
        self.trpz1.setObjectName("trpz1")
        self.label_22 = QtWidgets.QLabel(self.trapecia_page)
        self.label_22.setGeometry(QtCore.QRect(240, 200, 71, 31))
        self.label_22.setObjectName("label_22")
        self.trpz4 = QtWidgets.QDoubleSpinBox(self.trapecia_page)
        self.trpz4.setGeometry(QtCore.QRect(370, 190, 151, 41))
        self.trpz4.setObjectName("trpz4")
        self.trpz_height = QtWidgets.QLCDNumber(self.trapecia_page)
        self.trpz_height.setGeometry(QtCore.QRect(410, 330, 64, 23))
        self.trpz_height.setObjectName("trpz_height")
        self.label_23 = QtWidgets.QLabel(self.trapecia_page)
        self.label_23.setGeometry(QtCore.QRect(280, 330, 101, 17))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_24.setText(_translate("MainWindow", "სიგრძე"))
        self.label_25.setText(_translate("MainWindow", "გვერდი"))
        self.label_26.setText(_translate("MainWindow", "ფართობი"))
        self.label_17.setText(_translate("MainWindow", "გვერდი2"))
        self.label_18.setText(_translate("MainWindow", "გვერდი3"))
        self.label_19.setText(_translate("MainWindow", "პერიმეტრი"))
        self.label_20.setText(_translate("MainWindow", "გვერდი1"))
        self.label_21.setText(_translate("MainWindow", "ფართობი"))
        self.label_22.setText(_translate("MainWindow", "გვერდი4"))
        self.label_23.setText(_translate("MainWindow", "სიმაღლე"))
